...
ILOUSERCUTCALLBACK1(Cortes, IloBoolVarArray, x) {
  ...
  // status = CPXgetcallbacknodeinfo(env, cbdata, wherefrom, 0, CPX_CALLBACK_INFO_NODE_DEPTH, &node_depth);
  // if (status)
  //   errormsg("Cortes: Erro ao obter profundidade do no.\n", __LINE__, status);
...
/******************************************************************************\
 * Esta rotina serve apenas para guardar a profundidade de cada nó na
 * arvore de branch and bound.
 * Autor: Rafael Cano
 * Data: 03/2018
 \*****************************************************************************/
